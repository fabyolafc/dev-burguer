...
function updateCartModal() {
    ...
    cart.forEach(item => {
        ...
        <div class="flex items-center justify-between">
            ...
            <button class="remove-from-cart-btn" data-name="${item.name}" title="Remover item">
...
addressInput.addEventListener('input', function(event) {
    let inputValeue = event.target.value;
...
checkoutBtn.addEventListener('click', function() {
    ...
    if (!isOpen) {
        Toastify({
        text: "O restaurante está fechado no momento. Nosso horário de funcionamento é das 18h às 22h.",
        duration: 3000,
        close: true,
        gravity: "top",
        position: "right",
